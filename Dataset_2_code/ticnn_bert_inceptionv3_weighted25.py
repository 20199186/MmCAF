...
print("bert_inception_weighted25")
...
class WeightedSum(Layer):
    def __init__(self, a, **kwargs):
        self.a = tf.Variable(0.25,dtype=tf.float32, trainable=True)
...
def create_multimodal_model(
    ...
    # Concatenate the projections and pass through the classification layer.
    #concat = keras.layers.Concatenate()([vision_projections, text_projections])
    #outputs = keras.layers.Dense(3, activation="softmax")(concat)
